...
Userscript для Chrome и Firefox, добавляющий навигацию клавиатурой по отчетам на сайте https://tlib.ru/, показывающий вложенные GPS-треки, а также формирующий краткую сводку по архиву отчета, с возможностью загрузки отдельных файлов из архива.
